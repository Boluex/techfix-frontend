...
export const DownloadSection = () => {
  ...
  const LINUX_URL =
    "https://github.com/Boluex/techfix-frontend/releases/download/1.0/TechFix.Ai.Agent.linux.zip";
  const WINDOWS_URL =
          ...
          <div>
            ...
            <div className="mt-6 p-4 bg-yellow-50/50 border border-yellow-200 rounded-lg">
              <p className="text-sm text-yellow-800">
                💡 No payment required! We'll email your service token within minutes.
              </p>
            </div>
          </div>
